...
set "APP_CLASSPATH=%APP_LIB_DIR%\infothunder.reactive.music-interface-0.2.jar;%APP_LIB_DIR%\commons-httpclient-3.0.jar;%APP_LIB_DIR%\commons-io-2.4.jar;%APP_LIB_DIR%\commons-logging.jar;%APP_LIB_DIR%\httpclient-4.3.5.jar;%APP_LIB_DIR%\httpcore-4.3.2.jar;%APP_LIB_DIR%\ojdbc14.jar;%APP_LIB_DIR%\org.scala-lang.scala-library-2.10.5.jar;%APP_LIB_DIR%\io.spray.spray-json_2.10-1.3.2.jar;%APP_LIB_DIR%\io.spray.spray-can_2.10-1.3.2.jar;%APP_LIB_DIR%\io.spray.spray-io_2.10-1.3.2.jar;%APP_LIB_DIR%\io.spray.spray-util_2.10-1.3.2.jar;%APP_LIB_DIR%\io.spray.spray-http_2.10-1.3.2.jar;%APP_LIB_DIR%\org.parboiled.parboiled-scala_2.10-1.1.6.jar;%APP_LIB_DIR%\org.parboiled.parboiled-core-1.1.6.jar;%APP_LIB_DIR%\io.spray.spray-routing_2.10-1.3.2.jar;%APP_LIB_DIR%\io.spray.spray-httpx_2.10-1.3.2.jar;%APP_LIB_DIR%\org.jvnet.mimepull.mimepull-1.9.4.jar;%APP_LIB_DIR%\com.chuusai.shapeless_2.10-1.2.4.jar;%APP_LIB_DIR%\com.typesafe.akka.akka-actor_2.10-2.3.9.jar;%APP_LIB_DIR%\com.typesafe.config-1.2.1.jar;%APP_LIB_DIR%\org.json4s.json4s-native_2.10-3.2.4.jar;%APP_LIB_DIR%\org.json4s.json4s-core_2.10-3.2.4.jar;%APP_LIB_DIR%\org.json4s.json4s-ast_2.10-3.2.4.jar;%APP_LIB_DIR%\com.thoughtworks.paranamer.paranamer-2.5.2.jar;%APP_LIB_DIR%\org.scala-lang.scalap-2.10.0.jar;%APP_LIB_DIR%\org.scala-lang.scala-compiler-2.10.0.jar;%APP_LIB_DIR%\org.scala-lang.scala-reflect-2.10.0.jar;%APP_LIB_DIR%\c3p0.c3p0-0.9.1.2.jar"
